# Play-Annotation-Generator Annotation Review — BootPass_45
...
- **Inferred Coverage Segments (Action_None):** 34
...
| ✅ EXACT | `Action_SnapReceive` | Position_Unknown | `19` | `19` | 75 | END | 75 | 75 |
| ✅ EXACT | `Action_BootAway` | Position_Unknown | `19` | `19` | 114 | START | 114 | 155 |
| ✅ EXACT | `Action_RunFlatRoute` | Position_Unknown | `1` | `1` | 130 | START | 130 | 173 |
| ✅ EXACT | `Action_ThrowPass` | Position_Unknown | `19` | `19` | 169 | START | 169 | 180 |
| ✅ EXACT | `Action_SecureCatch` | Position_Unknown | `2` | `2` | 206 | START | 206 | 210 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `0` | Position_Unknown | Team_Unknown | 0–210 | 205 | 2 | Undefined position; Undefined team |
| `1` | `1` | Position_Unknown | Team_Unknown | 0–208 | 209 | 3 | Undefined position; Undefined team |
| `2` | `2` | Position_Unknown | Team_Unknown | 0–210 | 211 | 2 | Undefined position; Undefined team |
| `3` | `3` | Position_Unknown | Team_Unknown | 0–210 | 208 | 3 | Undefined position; Undefined team |
...
| `17` | `17` | Position_Unknown | Team_Unknown | 0–106 | 105 | 2 | Undefined position; Undefined team |
| `18` | `18` | Position_Unknown | Team_Unknown | 0–210 | 211 | 1 | Undefined position; Undefined team |
| `19` | `19` | Position_Unknown | Team_Unknown | 0–210 | 211 | 7 | Undefined position; Undefined team |
| `20` | `20` | Position_Unknown | Team_Unknown | 0–108 | 109 | 1 | Undefined position; Undefined team |
| `21` | `21` | Position_Unknown | Team_Unknown | 0–210 | 210 | 2 | Undefined position; Undefined team |
| `22` | `22` | Position_Unknown | Team_Unknown | 99–210 | 112 | 1 | Undefined position; Undefined team |
| `23` | `23` | Position_Unknown | Team_Unknown | 107–210 | 104 | 1 | Undefined position; Undefined team |
| `24` | `27` | Position_Unknown | Team_Unknown | 206–208 | 3 | 1 | Undefined position; Undefined team |
...
| Missing visible bounding boxes during action | 30 |
| Other | 2 |
...
- ⚠️ Action 'Action_PreSnap' range [145-210] for track '0' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_None' range [174-208] for track '1' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_SecureCatch' range [206-210] for track '2' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [0-103] for track '3' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [106-128] for track '3' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [130-210] for track '3' has 1 frames without a visible bounding box.
...
- ⚠️ Action 'Action_PreSnap' range [0-210] for track '16' has 2 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [0-100] for track '17' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [103-106] for track '17' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [0-210] for track '18' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_None' range [181-210] for track '19' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [0-108] for track '20' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [0-136] for track '21' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [138-210] for track '21' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [99-210] for track '22' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [107-210] for track '23' has 1 frames without a visible bounding box.
- ⚠️ Action 'Action_PreSnap' range [206-208] for track '24' has 1 frames without a visible bounding box.
